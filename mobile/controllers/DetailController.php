...
/**
 * @Id DetailController.php 2025.08.05 $
 * @author mosir
 */

class DetailController extends \common\controllers\BaseMallController
{
	/**
	 * 初始化
	 * @var array $view 当前视图
	...
	public function init()
	{
		...
		$this->params = ArrayHelper::merge($this->params, Page::getAssign('store'));
	}
	...
	public function actionIndex()
    {
		...
		$this->params['_foot_tags'] = Resource::import([
			'script' => 'jquery.plugins/jquery.infinite.js,jquery.plugins/fresco/fresco.js,cart.js,jquery.plugins/raty/jquery.raty.js,jquery.plugins/jquery.lazyload.js',
		...
		//var_dump($this->params['goods']);die;
